...
def pccHelp():
    return("概要\n"
            ...
            "使い方\n"
            "　　pccadmin [コマンド] [ターゲット] [オプション]...\n"
            "コマンド一覧\n"
            "<IaaS管理系>\n"
            "　　pccadmin list iaas [オプション]...　　　　　　 PCCがサポートしているIaaSの一覧表示を行います。\n"
            "　　pccadmin show iaas [オプション]...　　　　　　 PCCがサポートしているIaaSの詳細情報表示を行います。\n"
            "\n"
            "<プラットフォーム管理系>\n"
            "　　pccadmin add platform [オプション]...　　　　　各種IaaSプラットフォームの新規追加を行います。\n"
            "　　pccadmin update platform [オプション]...　　　 登録されたプラットフォーム情報の更新を行います。\n"
            "　　pccadmin del platform [オプション]...　　　　　登録されたプラットフォーム情報の削除を行います。\n"
            "　　pccadmin enable platform [オプション]...　　　 指定されたプラットフォームの有効化を行います。\n"
            "　　pccadmin disable platform [オプション]...　　　指定されたプラットフォームの無効化を行います。\n"
            "　　pccadmin list platform [オプション]...　　　　 プラットフォームの一覧表示を行います。\n"
            "　　pccadmin show platform [オプション]...　　　　 指定されたプラットフォームの詳細情報表示を行います。\n"
            "\n"
            "<インスタンスタイプ管理系>\n"
            "　　pccadmin add instancetype [オプション]...　　　プラットフォームのインスタンスタイプ新規追加を行います。\n"
            "　　pccadmin update instancetype [オプション]...　 プラットフォームのインスタンスタイプ更新を行います。\n"
            "　　pccadmin del instancetype [オプション]...　　　プラットフォームのインスタンスタイプ削除を行います。\n"
            "　　pccadmin list instancetype [オプション]...　　 インスタンスタイプの一覧表示を行います。\n"
            "\n"
            "<ストレージタイプ管理系>\n"
            "　　pccadmin add storagetype [オプション]...　　　 プラットフォームのストレージタイプ新規追加を行います。\n"
            "　　pccadmin update storagetype [オプション]...　　プラットフォームのストレージタイプ更新を行います。\n"
            "　　pccadmin del storagetype [オプション]...　　　 プラットフォームのストレージタイプ削除を行います。\n"
            "　　pccadmin list storagetype [オプション]...　　　ストレージタイプの一覧表示を行います。\n"
            "\n"
            "<イメージ管理系>\n"
            "　　pccadmin add image [オプション]...　　　　　　 OSイメージの新規追加を行います。\n"
            "　　pccadmin update image [オプション]...　　　　　登録されたOSイメージの情報の更新を行います。\n"
            "　　pccadmin del image [オプション]...　　　　　　 登録されたOSイメージの情報の削除を行います。\n"
            "　　pccadmin enable image [オプション]...　　　　　指定されたOSイメージの有効化を行います。\n"
            "　　pccadmin disable image [オプション]...　　　　 指定されたOSイメージの無効化を行います。\n"
            "　　pccadmin list image [オプション]...　　　　　　OSイメージの一覧表示を行います。\n"
            "　　pccadmin show image [オプション]...　　　　　　指定されたOSイメージの詳細情報表示を行います。\n"
            "\n"
            "<サービス管理系>\n"
            "　　pccadmin add service [オプション]...　　　　　 サービスの新規追加を行います。\n"
            "　　pccadmin update service [オプション]...　　　　登録されたサービスの情報の更新を行います。\n"
            "　　pccadmin delete service [オプション]...　　　　登録されたサービスの情報の削除を行います。\n"
            "　　pccadmin enable service [オプション]...　　　　登録されたサービスの有効化を行います。\n"
            "　　pccadmin disable service [オプション]...　　　 登録されたサービスの無効化を行います。\n"
            "　　pccadmin list service [オプション]...　　　　　サービスの一覧表示を行います。\n"
            "　　pccadmin show service [オプション]...　　　　　指定されたサービスの詳細情報表示を行います。\n"
            "　　pccadmin validate service [オプション]...　　　イメージ上で利用可能なサービス情報の追加を行います。\n"
            "　　pccadmin revoke service [オプション]...　　　　イメージ上で利用可能なサービス情報の削除を行います。\n")

def addHelp():
    return("概要\n"
            "　　PCCの各種データを追加するためのコマンドです。\n"
            "使い方\n"
            "　　pccadmin add [ターゲット] [オプション]...\n"
            "コマンド一覧\n"
            "　　pccadmin add platform [オプション]...　　　　　各種IaaSプラットフォームの新規追加を行います。\n"
            "　　pccadmin add instancetype [オプション]...　　　プラットフォームのインスタンスタイプ新規追加を行います。\n"
            "　　pccadmin add storagetype [オプション]...　　　 プラットフォームのストレージタイプ新規追加を行います。\n"
...
def updatePlatformHelp():
    return("概要\n"
            ...
            "使い方\n"
            "　　pccadmin update platform [オプション]...\n"
            "指定可能な引数\n"
...
def enablePlatformHelp():
    return("概要\n"
            "　　プラットフォームの有効化を行います。\n"
            "使い方\n"
            "　　pccadmin enable platform [オプション]...\n"
            "指定可能な引数\n"
...
def disablePlatformHelp():
    return("概要\n"
            "　　プラットフォームの無効化を行います。\n"
            "使い方\n"
            "　　pccadmin disable platform [オプション]...\n"
            "指定可能な引数\n"
...
def addInstanceTypeHelp():
    return("概要\n"
            ...
            "使い方\n"
            "　　pccadmin add instancetype [オプション]...\n"
            "指定可能な引数\n"
...
def updateInstanceTypeHelp():
    return("概要\n"
            ...
            "使い方\n"
            "　　pccadmin update instancetype [オプション]...\n"
            "指定可能な引数\n"
...
def deleteInstanceTypeHelp():
    return("概要\n"
            ...
            "使い方\n"
            "　　pccadmin del instancetype [オプション]...\n"
            "指定可能な引数\n"
...
def listInstanceTypeHelp():
    return("概要\n"
            "　　インスタンスタイプの一覧表示を行います。\n"
            "使い方\n"
            "　　pccadmin list instancetype [オプション]...\n"
            "指定可能な引数\n"
...
def addStorageTypeHelp():
    return("概要\n"
            ...
            "使い方\n"
            "　　pccadmin add storagetype [オプション]...\n"
            "指定可能な引数\n"
            "　　--platformName [プラットフォーム名称]　　　　　 必須　追加対象プラットフォーム名称を指定します。\n"
...
def updateStorageTypeHelp():
    return("概要\n"
            ...
            "使い方\n"
            "　　pccadmin update storagetype [オプション]...\n"
            "指定可能な引数\n"
...
def deleteStorageTypeHelp():
    return("概要\n"
            ...
            "使い方\n"
            "　　pccadmin del storagetype [オプション]...\n"
            "指定可能な引数\n"
            "　　--platformName [プラットフォーム名称]　　　　　 必須　削除対象のプラットフォーム名称を指定します。\n"
...
def listStorageTypeHelp():
    return("概要\n"
            "　　ストレージタイプの一覧表示を行います。\n"
            "使い方\n"
            "　　pccadmin list storagetype [オプション]...\n"
            "指定可能な引数\n"
...
def disableServiceHelp():
    return ("概要\n"
            "　　指定したサービスを無効化します。\n"
            "使い方\n"
            "　　pccadmin disable service [オプション]...\n"
            "指定可能な引数\n"
...
def validateServiceHelp():
    return("概要\n"
            ...
            "使い方\n"
            "　　pccadmin validate service [オプション]...\n"
            "指定可能な引数\n"
