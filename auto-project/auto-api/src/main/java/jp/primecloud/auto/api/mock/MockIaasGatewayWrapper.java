...
public class MockIaasGatewayWrapper extends IaasGatewayWrapper {
    ...
    public MockIaasGatewayWrapper(Long userNo, Long platformNo, Integer describeInterval, EventLogger eventLogger) {
        super(userNo, platformNo, describeInterval, eventLogger);
    }
