...
public class ApiValidate extends ApiConstants {
    ...
    public static void validateTimestamp(String timestamp) {
        ValidateUtil.required(timestamp, "EAPI-000001",
                new Object[] {PARAM_NAME_TIMESTAMP});
        ValidateUtil.isDate(timestamp, "EAPI-000005",
                DATE_FORMAT_YYYYMMDD_HHMMSS, new Object[] {PARAM_NAME_TIMESTAMP});
    }

    public static void validateSignature(String signature) {
        ValidateUtil.required(signature, "EAPI-000001",
                new Object[] {PARAM_NAME_SIGNATURE});
    }
    ...
    public static void validateComponentName(String componentName) {
        ...
        ValidateUtil.lengthInRange(componentName, 1, 15, "EAPI-000003",
                new Object[] {PARAM_NAME_COMPONENT_NAME, 15});
        ValidateUtil.matchRegex(componentName, "^[0-9a-z]|[0-9a-z][0-9a-z-]*[0-9a-z]$",
                "EAPI-000004", new Object[] {PARAM_NAME_COMPONENT_NAME});
    }
    ...
    public static void validateDiskSize(String diskSize) {
        ...
        ValidateUtil.intInRange(diskSize, 1, 1000, "EAPI-000002",
                new Object[] {PARAM_NAME_DISK_SIZE, 1, 1000});
    }

    public static void validateComment(String comment){
        ValidateUtil.lengthInRange(comment, 0, 100, "EAPI-000003",
                new Object[] {PARAM_NAME_COMMENT, 100});
    }

    public static void validateIsStopInstance(String isStopInstance){
        if(StringUtils.isNotEmpty(isStopInstance)) {
            ValidateUtil.isBoolean(isStopInstance, "EAPI-000009",
                    new Object[] {PARAM_NAME_IS_STOP_INSTANCE});
        }
    }
    ...
    public static void validatePlatformNo(String platformNo) {
        ...
        ValidateUtil.longInRange(platformNo, 1, Long.MAX_VALUE,
                "EAPI-000002", new Object[] {PARAM_NAME_PLATFORM_NO, 1, Long.MAX_VALUE});
    }

    public static void validateInstanceNo(String instanceNo) {
        ValidateUtil.required(instanceNo, "EAPI-000001",
                new Object[] {PARAM_NAME_INSTANCE_NO});
        ValidateUtil.longInRange(instanceNo, 1, Long.MAX_VALUE,
                "EAPI-000002", new Object[] {PARAM_NAME_INSTANCE_NO, 1, Long.MAX_VALUE});
    }
    ...
    public static void validateImageNo(String imageNo) {
        ...
        ValidateUtil.longInRange(imageNo, 1, Long.MAX_VALUE,
                "EAPI-000002", new Object[] {PARAM_NAME_IMAGE_NO, 1, Long.MAX_VALUE});
    }
    ...
    public static void validateInstanceName(String instanceName) {
        ...
        ValidateUtil.lengthInRange(instanceName, 1, 15,
                "EAPI-000003", new Object[] {PARAM_NAME_INSTANCE_NAME, 15});
        ValidateUtil.matchRegex(instanceName, "^[a-z]|[a-z][0-9a-z-]*[0-9a-z]$",
                "EAPI-000004", new Object[] {PARAM_NAME_INSTANCE_NAME});
        if (instanceName.startsWith("lb-")) {
            //「lb-」から始まる名称は使用不可
            throw new AutoApplicationException("EAPI-000014", PARAM_NAME_INSTANCE_NAME,
                    "lb-", instanceName);
        }
    }
    ...
    public static void validateInstanceType(String instanceType, boolean isRequired) {
        ...
        ValidateUtil.lengthInRange(instanceType, 0, 20,
                "EAPI-000003", new Object[] {PARAM_NAME_INSTANCE_TYPE, 20});
    }

    public static void validateIsStartService(String isStartService){
        if(StringUtils.isNotEmpty(isStartService)) {
            ValidateUtil.isBoolean(isStartService, "EAPI-000009",
                    new Object[] {PARAM_NAME_IS_START_SERVICE});
        }
    }

    public static void validateLoadBalancerNo(String loadBalancerNo) {
        ValidateUtil.required(loadBalancerNo, "EAPI-000001",
                new Object[] {PARAM_NAME_LOAD_BALANCER_NO});
        ValidateUtil.longInRange(loadBalancerNo, 1, Long.MAX_VALUE,
    ...
    public static void validateServicePort(String servicePort) {
        ValidateUtil.required(servicePort, "EAPI-000001",
                new Object[] {PARAM_NAME_SERVICE_PORT});
        ValidateUtil.intInRange(servicePort, 1, 65535,
                "EAPI-000002", new Object[] {PARAM_NAME_SERVICE_PORT, 1, 65535});
    }
    ...
    public static void validatePassword(String password) {
        ...
        ValidateUtil.lengthInRange(password, 1, 15,
    ...
    public static void validateTemplateNo(String templateNo) {
        ...
        ValidateUtil.longInRange(templateNo, 1, Long.MAX_VALUE,
                "EAPI-000002", new Object[] {PARAM_NAME_TEMPLATE_NO, 1, Long.MAX_VALUE});
    }
    ...
    public static void validateIpAddress(String ipAddress, boolean isRequired) {
        if (isRequired) {
            ValidateUtil.required(ipAddress, "EAPI-000001",
                    new Object[] {PARAM_NAME_IP_ADDRESS});
        }
    ...
    public static void validateKeyPairNo(String keyPairNo) {
        ValidateUtil.required(keyPairNo, "EAPI-000001",
                new Object[] {PARAM_NAME_KEY_PAIR_NO});
        ValidateUtil.longInRange(keyPairNo, 1, Long.MAX_VALUE,
                "EAPI-000002", new Object[] {PARAM_NAME_KEY_PAIR_NO, 1, Long.MAX_VALUE});
    }

    public static void validateComputeResource(String computeResource) {
        ValidateUtil.required(computeResource, "EAPI-000001",
                new Object[] {PARAM_NAME_COMPUTE_RESOURCE});
    }

    public static void validateIsStaticIp(String isStaticIp) {
        ValidateUtil.required(isStaticIp, "EAPI-000001",
                new Object[] {PARAM_NAME_IS_STATIC_IP});
        ValidateUtil.isBoolean(isStaticIp, "EAPI-000009",
                new Object[] {PARAM_NAME_IS_STATIC_IP});
    }

    public static void validateSubnetMask(String subnetMask) {
        ValidateUtil.required(subnetMask, "EAPI-000001",
                new Object[] {PARAM_NAME_SUBNET_MASK});
    ...
    public static void validateDefaultGateway(String defaultGateway) {
        ValidateUtil.required(defaultGateway, "EAPI-000001",
                new Object[] {PARAM_NAME_DEFAULT_GATEWAY});
    ...
    public static void validateAvailabilityZone(String availabilityZoneName) {
        ValidateUtil.lengthInRange(availabilityZoneName, 0, 100,
                "EAPI-000003", new Object[] {PARAM_NAME_AVAILABILITY_ZONE, 100});
    }

    public static void validateLoadBalancerName(String loadBalancerName) {
        ValidateUtil.required(loadBalancerName, "EAPI-000001",
                new Object[] {PARAM_NAME_LOAD_BALANCER_NAME});
        ValidateUtil.lengthInRange(loadBalancerName, 1, 15,
                "EAPI-000003", new Object[] {PARAM_NAME_LOAD_BALANCER_NAME, 15});
        ValidateUtil.matchRegex(loadBalancerName, "^[0-9a-z]|[0-9a-z][0-9a-z-]*[0-9a-z]$",
                "EAPI-000004", new Object[] {PARAM_NAME_LOAD_BALANCER_NAME});
        if (loadBalancerName.startsWith("lb-")) {
            //「lb-」から始まる名称は使用不可
            throw new AutoApplicationException("EAPI-000014", PARAM_NAME_LOAD_BALANCER_NAME,
                    "lb-", loadBalancerName);
        }
    }

    public static void validateLoadBalancerType(String loadBalancerType) {
        ValidateUtil.required(loadBalancerType, "EAPI-000001",
                new Object[] {PARAM_NAME_LOAD_BALANCER_TYPE});
...
//                new Object[] {PARAM_NAME_LOAD_BALANCER_TYPE, "aws or ultramonkey or cloudstack"});
    ...
    public static void validateEnabled(String enabled) {
        ValidateUtil.required(enabled, "EAPI-000001",
                new Object[] {PARAM_NAME_ENABLED});
        ValidateUtil.isBoolean(enabled, "EAPI-000009",
                new Object[] {PARAM_NAME_ENABLED});
    }

    public static void validateNamingRule(String namingRule) {
        ValidateUtil.required(namingRule, "EAPI-000001",
                new Object[] {PARAM_NAME_NAMING_RULE});
        ValidateUtil.matchRegex(namingRule, "^[a-z]|[a-z][0-9a-z-]*[0-9a-z]$",
                "EAPI-000004", new Object[] {PARAM_NAME_NAMING_RULE});
        ValidateUtil.lengthInRange(namingRule, 1, 10, "EAPI-000003",
                new Object[] {PARAM_NAME_NAMING_RULE, 10});
    }

    public static void validateIdleTimeMax(String idleTimeMax) {
        ValidateUtil.required(idleTimeMax, "EAPI-000001",
                new Object[] {PARAM_NAME_IDLE_TIME_MAX});
        ValidateUtil.longInRange(idleTimeMax, 0, 100, "EAPI-000002",
                new Object[] {PARAM_NAME_IDLE_TIME_MAX, 0, 100});
    }

    public static void validateIdleTimeMin(String idleTimeMin) {
        ValidateUtil.required(idleTimeMin, "EAPI-000001",
                new Object[] {PARAM_NAME_IDLE_TIME_MIN});
        ValidateUtil.longInRange(idleTimeMin, 0, 100, "EAPI-000002",
                new Object[] {PARAM_NAME_IDLE_TIME_MIN, 0, 100});
    }

    public static void validateContinueLimit(String continueLimit) {
        ValidateUtil.required(continueLimit, "EAPI-000001",
                new Object[] {PARAM_NAME_CONTINUE_LIMIT});
    ...
    public static void validateAddCount(String addCount) {
        ValidateUtil.required(addCount, "EAPI-000001",
                new Object[] {PARAM_NAME_ADD_COUNT});
        ValidateUtil.longInRange(addCount, 1, 10, "EAPI-000002",
                new Object[] {PARAM_NAME_ADD_COUNT, 1, 10});
    }

    public static void validateDelCount(String delCount) {
        ValidateUtil.required(delCount, "EAPI-000001",
                new Object[] {PARAM_NAME_DEL_COUNT});
        ValidateUtil.longInRange(delCount, 1, 10, "EAPI-000002",
                new Object[] {PARAM_NAME_DEL_COUNT, 1, 10});
    }

    public static void validateCheckProtocol(String checkProtocol) {
        ValidateUtil.required(checkProtocol, "EAPI-000001",
                new Object[] {PARAM_NAME_CHECK_PROTOCOL});
    ...
    public static void validateCheckPort(String checkPort) {
        ValidateUtil.required(checkPort, "EAPI-000001",
                new Object[] {PARAM_NAME_CHECK_PORT});
        ValidateUtil.intInRange(checkPort, 1, 65535, "EAPI-000002",
                new Object[] {PARAM_NAME_CHECK_PORT, 1, 65535});
    }

    public static void validateCheckPath(String checkPath, boolean isRequired) {
        if (isRequired) {
            ValidateUtil.required(checkPath, "EAPI-000001",
                    new Object[] {PARAM_NAME_CHECK_PATH});
        }
        ValidateUtil.lengthInRange(checkPath, 0, 100, "EAPI-000003",
                new Object[] {PARAM_NAME_CHECK_PATH, 100});
    }

    public static void validateCheckTimeout(String checkTimeout) {
        ValidateUtil.required(checkTimeout, "EAPI-000001",
                new Object[] {PARAM_NAME_CHECK_TIMEOUT});
        ValidateUtil.intInRange(checkTimeout, 2, 60, "EAPI-000002",
                new Object[] {PARAM_NAME_CHECK_TIMEOUT, 2, 60});
    }

    public static void validateCheckInterval(String checkInterval) {
        ValidateUtil.required(checkInterval, "EAPI-000001",
                new Object[] {PARAM_NAME_CHECK_INTERVAL});
    ...
    public static void validateHealthyThreshold(String healthyThreshold) {
        ValidateUtil.required(healthyThreshold, "EAPI-000001",
                new Object[] {PARAM_NAME_HEALTHY_THRESHOLD});
    ...
    public static void validateUnhealthyThreshold(String unhealthyThreshold) {
        ValidateUtil.required(unhealthyThreshold, "EAPI-000001",
                new Object[] {PARAM_NAME_UNHEALTHY_THRESHOLD});
    ...
    public static void validateInstanceNos(String instanceNos, boolean isLongInRange) {
        ValidateUtil.required(instanceNos, "EAPI-000001",
                new Object[] {PARAM_NAME_INSTANCE_NOS});
        if (isLongInRange) {
            ValidateUtil.longInRange(instanceNos, 1, Long.MAX_VALUE,
                    "EAPI-000002", new Object[] {PARAM_NAME_INSTANCE_NOS, 1, Long.MAX_VALUE});
        }
    }

    public static void validateSubnet(String subnet) {
        ValidateUtil.required(subnet, "EAPI-000001",
                new Object[] {PARAM_NAME_SUBNET});
    }
    ...
    public static void validateIsFromCurrent(String isFromCurrent) {
        ValidateUtil.required(isFromCurrent, "EAPI-000001",
                new Object[] {PARAM_NAME_IS_FROM_CURRENT});
        ValidateUtil.isBoolean(isFromCurrent, "EAPI-000009",
                new Object[] {PARAM_NAME_IS_FROM_CURRENT});
    }
    ...
    public static void validateFromDate(String fromDate) {
        ValidateUtil.required(fromDate, "EAPI-000001",
                new Object[] {PARAM_NAME_FROM_DATE});
        ValidateUtil.isDate(fromDate, "EAPI-000005",
                DATE_FORMAT_YYYYMMDD_HHMMSS, new Object[] {PARAM_NAME_FROM_DATE});
    }

    public static void validateToDate(String toDate) {
        if (StringUtils.isNotEmpty(toDate)) {
            ValidateUtil.isDate(toDate, "EAPI-000005",
                    DATE_FORMAT_YYYYMMDD_HHMMSS, new Object[] {PARAM_NAME_TO_DATE});
        }
    }
    ...
    public static void validateOrderName(String orderName) {
        ValidateUtil.required(orderName, "EAPI-000001",
        ...
        ValidateUtil.matchRegex(orderName, "Date|LogLevel|FarmName|ComponentName|InstanceName|Message", "EAPI-000006",
                new Object[] {PARAM_NAME_ORDER_NAME, "Date or LogLevel or FarmName or ComponentName or InstanceName or Message"});
    }

    public static void validateOrderAscDesc(String orderAscDesc) {
        ValidateUtil.required(orderAscDesc, "EAPI-000001",
                new Object[] {PARAM_NAME_ORDER_ASC_DESC});
    ...
    public static void validateAccessId(String accessId) {
        ValidateUtil.required(accessId, "EAPI-000001",
                new Object[] {PARAM_NAME_ACCESS_ID});
    }
    ...
    public static void validateCustomParam1(String customParam1) {
        ...
        ValidateUtil.lengthInRange(customParam1, 0, 200,
                "EAPI-000003", new Object[] {PARAM_NAME_CUSTOM_PARAM_1, 200});
    }
    ...
    public static void validateCustomParam2(String customParam2) {
        ...
        ValidateUtil.lengthInRange(customParam2, 0, 200,
                "EAPI-000003", new Object[] {PARAM_NAME_CUSTOM_PARAM_2, 200});
    }
    ...
    public static void validateCustomParam3(String customParam3) {
        ...
        ValidateUtil.lengthInRange(customParam3, 0, 200,
                "EAPI-000003", new Object[] {PARAM_NAME_CUSTOM_PARAM_3, 200});
    }
