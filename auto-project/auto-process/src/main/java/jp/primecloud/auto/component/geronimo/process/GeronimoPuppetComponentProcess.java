 ...
 */
package jp.primecloud.auto.component.geronimo.process;
 ...
 *
 */
public class GeronimoPuppetComponentProcess extends PuppetComponentProcess {

    /**
     * TODO: コンストラクタコメントを記述
     */
    public GeronimoPuppetComponentProcess() {
        componentTypeName = GeronimoConstants.COMPONENT_TYPE_NAME;
        awsVolumeDevice = GeronimoConstants.AWS_VOLUME_DEVICE;
        vmwareDiskScsiId = GeronimoConstants.VMWARE_DISK_SCSI_ID;
    }
