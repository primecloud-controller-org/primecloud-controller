 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{https://cp.cloud.nifty.com/api/1.3/}DescribeImagesItemType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DescribeImagesInfoType {
    ...
    public DescribeImagesInfoType withItem(DescribeImagesItemType... values) {
        if (values!= null) {
            for (DescribeImagesItemType value: values) {
                getItem().add(value);
            }
        }
        return this;
