...
public class InstanceIdType {
    ...
    public InstanceIdType withInstanceId(String value) {
        setInstanceId(value);
        return this;
    }

    public InstanceIdType withAccountingType(String value) {
        setAccountingType(value);
        return this;
    }

    public InstanceIdType withInstanceType(String value) {
