 ...
 *         &lt;element name="imagesSet" type="{https://cp.cloud.nifty.com/api/1.3/}DescribeImagesResponseInfoType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DescribeImagesResponseType {
    ...
    public DescribeImagesResponseType withRequestId(String value) {
        setRequestId(value);
        return this;
    }

    public DescribeImagesResponseType withImagesSet(DescribeImagesResponseInfoType value) {
        setImagesSet(value);
        return this;
    }
