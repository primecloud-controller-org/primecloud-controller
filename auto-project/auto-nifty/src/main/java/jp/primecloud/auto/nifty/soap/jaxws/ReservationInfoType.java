...
public class ReservationInfoType {
    ...
    public ReservationInfoType withReservationId(String value) {
        setReservationId(value);
        return this;
    }

    public ReservationInfoType withOwnerId(String value) {
        setOwnerId(value);
        return this;
    }

    public ReservationInfoType withGroupSet(GroupSetType value) {
        setGroupSet(value);
        return this;
    }

    public ReservationInfoType withInstancesSet(RunningInstancesSetType value) {
        setInstancesSet(value);
        return this;
    }

    public ReservationInfoType withRequesterId(String value) {
