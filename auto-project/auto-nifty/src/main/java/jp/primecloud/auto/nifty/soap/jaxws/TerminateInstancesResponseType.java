 ...
 *         &lt;element name="instancesSet" type="{https://cp.cloud.nifty.com/api/1.3/}InstanceStateChangeSetType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TerminateInstancesResponseType {
    ...
    public TerminateInstancesResponseType withRequestId(String value) {
        setRequestId(value);
        return this;
    }

    public TerminateInstancesResponseType withInstancesSet(InstanceStateChangeSetType value) {
