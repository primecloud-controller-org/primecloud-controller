...
public class DetachVolumeType {
    ...
    public DetachVolumeType withVolumeId(String value) {
        setVolumeId(value);
        return this;
    }

    public DetachVolumeType withInstanceId(String value) {
        setInstanceId(value);
        return this;
    }

    public DetachVolumeType withDevice(String value) {
        setDevice(value);
        return this;
    }

    public DetachVolumeType withForce(Boolean value) {
        setForce(value);
        return this;
    }
