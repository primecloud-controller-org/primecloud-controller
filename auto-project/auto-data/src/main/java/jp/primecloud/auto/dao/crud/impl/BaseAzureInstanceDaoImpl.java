...
import jp.primecloud.auto.dao.crud.BaseAzureInstanceDao;
import jp.primecloud.auto.entity.crud.AzureInstance;

/**
 * <p>
 * {@link BaseAzureInstanceDao}の実装クラスです。
 * </p>
 *
 */
public abstract class BaseAzureInstanceDaoImpl extends SqlMapClientDaoSupport implements BaseAzureInstanceDao {
     ...
     */
    @Override
    public AzureInstance read(
            Long instanceNo
        ) {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("instanceNo", instanceNo);
        return (AzureInstance) getSqlMapClientTemplate().queryForObject(getSqlMapId("read"), paramMap);
    }
    ...
    public List<AzureInstance> readAll() {
        return (List<AzureInstance>) getSqlMapClientTemplate().queryForList(getSqlMapId("readAll"));
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<AzureInstance> readInInstanceNos(
            Collection<Long> instanceNos
        ) {
        if (instanceNos.isEmpty()) {
            return new ArrayList<AzureInstance>();
        }
        Map<String, Object> paramMap = new HashMap<String, Object>();
        ...
        return (List<AzureInstance>) getSqlMapClientTemplate().queryForList(getSqlMapId("readInInstanceNos"), paramMap);
    }
     ...
     */
    @Override
    public void create(AzureInstance entity) {
        String id = "create";
     ...
     */
    @Override
    public void update(AzureInstance entity) {
     ...
     */
    @Override
    public void delete(AzureInstance entity) {
