...
import jp.primecloud.auto.dao.crud.BaseOpenstackCertificateDao;
import jp.primecloud.auto.entity.crud.OpenstackCertificate;

/**
 * <p>
 * {@link BaseOpenstackCertificateDao}の実装クラスです。
 * </p>
 *
 */
public abstract class BaseOpenstackCertificateDaoImpl extends SqlMapClientDaoSupport implements BaseOpenstackCertificateDao {
    ...
    public OpenstackCertificate read(
        ...
        return (OpenstackCertificate) getSqlMapClientTemplate().queryForObject(getSqlMapId("read"), paramMap);
    }
    ...
    public List<OpenstackCertificate> readAll() {
        return (List<OpenstackCertificate>) getSqlMapClientTemplate().queryForList(getSqlMapId("readAll"));
    }
    ...
    public List<OpenstackCertificate> readByUserNo(
        ...
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("userNo", userNo);
        return (List<OpenstackCertificate>) getSqlMapClientTemplate().queryForList(getSqlMapId("readByUserNo"), paramMap);
    }
    ...
    public List<OpenstackCertificate> readInUserNos(
        ...
        if (userNos.isEmpty()) {
            return new ArrayList<OpenstackCertificate>();
        }
        Map<String, Object> paramMap = new HashMap<String, Object>();
        ...
        return (List<OpenstackCertificate>) getSqlMapClientTemplate().queryForList(getSqlMapId("readInUserNos"), paramMap);
    }
    ...
    public List<OpenstackCertificate> readInPlatformNos(
        ...
        paramMap.put("orderBys", new String[0]);
        return (List<OpenstackCertificate>) getSqlMapClientTemplate().queryForList(getSqlMapId("readInPlatformNos"), paramMap);
    }
