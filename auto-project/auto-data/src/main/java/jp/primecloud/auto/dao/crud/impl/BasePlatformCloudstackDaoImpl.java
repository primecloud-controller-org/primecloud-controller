...
import jp.primecloud.auto.dao.crud.BasePlatformCloudstackDao;
import jp.primecloud.auto.entity.crud.PlatformCloudstack;

/**
 * <p>
 * {@link BasePlatformCloudstackDao}の実装クラスです。
 * </p>
 *
 */
public abstract class BasePlatformCloudstackDaoImpl extends SqlMapClientDaoSupport implements BasePlatformCloudstackDao {

    protected String namespace = "PlatformCloudstack";
    ...
    public PlatformCloudstack read(
        ...
        return (PlatformCloudstack) getSqlMapClientTemplate().queryForObject(getSqlMapId("read"), paramMap);
    }
    ...
    public List<PlatformCloudstack> readAll() {
        return (List<PlatformCloudstack>) getSqlMapClientTemplate().queryForList(getSqlMapId("readAll"));
    }
    ...
    public List<PlatformCloudstack> readInPlatformNos(
        ...
        if (platformNos.isEmpty()) {
            return new ArrayList<PlatformCloudstack>();
        }
        Map<String, Object> paramMap = new HashMap<String, Object>();
        ...
        return (List<PlatformCloudstack>) getSqlMapClientTemplate().queryForList(getSqlMapId("readInPlatformNos"), paramMap);
    }
