...
import jp.primecloud.auto.dao.crud.BaseLoadBalancerHealthCheckDao;
...
/**
 * <p>
 * {@link BaseLoadBalancerHealthCheckDao}の実装クラスです。
 * </p>
 *
 */
public abstract class BaseLoadBalancerHealthCheckDaoImpl extends SqlMapClientDaoSupport implements BaseLoadBalancerHealthCheckDao {
     ...
     */
    @Override
    public LoadBalancerHealthCheck read(
            Long loadBalancerNo
        ) {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("loadBalancerNo", loadBalancerNo);
        return (LoadBalancerHealthCheck) getSqlMapClientTemplate().queryForObject(getSqlMapId("read"), paramMap);
    }
    ...
    public List<LoadBalancerHealthCheck> readAll() {
        return (List<LoadBalancerHealthCheck>) getSqlMapClientTemplate().queryForList(getSqlMapId("readAll"));
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<LoadBalancerHealthCheck> readInLoadBalancerNos(
            Collection<Long> loadBalancerNos
        ) {
        if (loadBalancerNos.isEmpty()) {
            return new ArrayList<LoadBalancerHealthCheck>();
        }
        Map<String, Object> paramMap = new HashMap<String, Object>();
        ...
        return (List<LoadBalancerHealthCheck>) getSqlMapClientTemplate().queryForList(getSqlMapId("readInLoadBalancerNos"), paramMap);
    }
