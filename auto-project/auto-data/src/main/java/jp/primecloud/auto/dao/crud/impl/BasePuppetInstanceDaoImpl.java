...
import jp.primecloud.auto.dao.crud.BasePuppetInstanceDao;
import jp.primecloud.auto.entity.crud.PuppetInstance;

/**
 * <p>
 * {@link BasePuppetInstanceDao}の実装クラスです。
 * </p>
 *
 */
public abstract class BasePuppetInstanceDaoImpl extends SqlMapClientDaoSupport implements BasePuppetInstanceDao {
     ...
     */
    @Override
    public PuppetInstance read(
            Long instanceNo
        ) {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("instanceNo", instanceNo);
        return (PuppetInstance) getSqlMapClientTemplate().queryForObject(getSqlMapId("read"), paramMap);
    }
    ...
    public List<PuppetInstance> readAll() {
        return (List<PuppetInstance>) getSqlMapClientTemplate().queryForList(getSqlMapId("readAll"));
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<PuppetInstance> readInInstanceNos(
            Collection<Long> instanceNos
        ) {
        if (instanceNos.isEmpty()) {
            return new ArrayList<PuppetInstance>();
        }
        Map<String, Object> paramMap = new HashMap<String, Object>();
        ...
        return (List<PuppetInstance>) getSqlMapClientTemplate().queryForList(getSqlMapId("readInInstanceNos"), paramMap);
    }
     ...
     */
    @Override
    public void create(PuppetInstance entity) {
        String id = "create";
     ...
     */
    @Override
    public void update(PuppetInstance entity) {
     ...
     */
    @Override
    public void delete(PuppetInstance entity) {
