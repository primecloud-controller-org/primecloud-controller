...
import jp.primecloud.auto.dao.crud.BasePlatformAzureDao;
import jp.primecloud.auto.entity.crud.PlatformAzure;

/**
 * <p>
 * {@link BasePlatformAzureDao}の実装クラスです。
 * </p>
 *
 */
public abstract class BasePlatformAzureDaoImpl extends SqlMapClientDaoSupport implements BasePlatformAzureDao {
     ...
     */
    @Override
    public PlatformAzure read(
            Long platformNo
        ) {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("platformNo", platformNo);
        return (PlatformAzure) getSqlMapClientTemplate().queryForObject(getSqlMapId("read"), paramMap);
    }
    ...
    public List<PlatformAzure> readAll() {
        return (List<PlatformAzure>) getSqlMapClientTemplate().queryForList(getSqlMapId("readAll"));
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<PlatformAzure> readInPlatformNos(
            Collection<Long> platformNos
        ) {
        if (platformNos.isEmpty()) {
            return new ArrayList<PlatformAzure>();
        }
        Map<String, Object> paramMap = new HashMap<String, Object>();
        ...
        return (List<PlatformAzure>) getSqlMapClientTemplate().queryForList(getSqlMapId("readInPlatformNos"), paramMap);
    }
