...
import jp.primecloud.auto.dao.crud.BaseAwsLoadBalancerDao;
import jp.primecloud.auto.entity.crud.AwsLoadBalancer;

/**
 * <p>
 * {@link BaseAwsLoadBalancerDao}の実装クラスです。
 * </p>
 *
 */
...
public abstract class BaseAwsLoadBalancerDaoImpl extends SqlMapClientDaoSupport implements BaseAwsLoadBalancerDao {
    ...
    public AwsLoadBalancer read(
        ...
        return (AwsLoadBalancer) getSqlMapClientTemplate().queryForObject(getSqlMapId("read"), paramMap);
    }
    ...
    public List<AwsLoadBalancer> readAll() {
        return (List<AwsLoadBalancer>) getSqlMapClientTemplate().queryForList(getSqlMapId("readAll"));
    }
    ...
    public List<AwsLoadBalancer> readInLoadBalancerNos(
        ...
        if (loadBalancerNos.isEmpty()) {
            return new ArrayList<AwsLoadBalancer>();
        }
        Map<String, Object> paramMap = new HashMap<String, Object>();
        ...
        return (List<AwsLoadBalancer>) getSqlMapClientTemplate().queryForList(getSqlMapId("readInLoadBalancerNos"), paramMap);
    }
